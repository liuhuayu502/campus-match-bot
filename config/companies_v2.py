...
常用URL模式:
- 字节跳动: https://jobs.bytedance.com/campus/position?project={ID}
- 腾讯: https://join.qq.com/post.html
- 阿里控股: https://talent-holding.alibaba.com/campus/home
- 美团: https://campus.meituan.com/web/campus
- 百度: https://talent.baidu.com/jobs/campus
