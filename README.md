# 🎯 校招岗位匹配助手 (Campus Match Bot) v2.2

找实习、春招，有简历但不知道投什么岗位，投什么部门，投什么事业部，用它！
上传简历，它能进大厂官网1对1根据岗位JD智能推荐岗位，从官网获取真实岗位数据，匹配你的简历。
内置10+大厂岗位结构图谱、岗位种类画像，知道5+大厂的部门架构，数据实时更新。
还能根据岗位JD，反向给出简历优化建议，提高机筛ATS通过率
